...
"""
# run train_covid19.py -d C:\Users\Behna\project\dataset
...
plt.savefig("plot_acc_BS_" + str(BS) + "_LR_" + str(INIT_LR) + "_EP_" + str(EPOCHS)+ ".png")
...
plt.ylabel("Loss")
plt.legend(loc="lower left")
plt.savefig("plot_loss_BS_" + str(BS) + "_LR_" + str(INIT_LR) + "_EP_" + str(EPOCHS)+ ".png")

# serialize the model to disk
print("[INFO] saving COVID-19 detector model...")
model.save("model_BS_" + str(BS) + "_LR_" + str(INIT_LR) + "_EP_" + str(EPOCHS), save_format="h5")